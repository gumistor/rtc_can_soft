...
void DS1340_getTime(time_struct_digits *timeBCD_ptr) 
{
    ...
    timeBCD_ptr->second_lsn  = timeDateStucture.second&0x0F;
    timeBCD_ptr->second_msn  = timeDateStucture.second>>4&0x0F;
    timeBCD_ptr->minute_lsn  = timeDateStucture.minute&0x0F;
    timeBCD_ptr->minute_msn  = timeDateStucture.minute>>4&0x0F;
    timeBCD_ptr->hour_lsn    = timeDateStucture.hour&0x0F;
    timeBCD_ptr->hour_msn    = timeDateStucture.hour>>4&0x0F;
    
    timeBCD_ptr->day_lsn  = timeDateStucture.day&0x0F;
    timeBCD_ptr->day_msn  = timeDateStucture.day>>4&0x0F;
    
    timeBCD_ptr->month_lsn  = timeDateStucture.month&0x0F;
    timeBCD_ptr->month_msn  = timeDateStucture.month>>4&0x0F;
    
    timeBCD_ptr->year_lsn  = timeDateStucture.year&0x0F;
    timeBCD_ptr->year_msn  = timeDateStucture.year>>4&0x0F;
    
    timeBCD_ptr->week  = timeDateStucture.week&0x0F;
}
